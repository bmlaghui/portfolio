  ...
  private dict: Record<string, Record<string, any>> = {
    fr: {
      ...
      hero: {
        ...
        lead: 'Tech Lead et développeur Full-Stack avec plus de 10 ans d\'expérience, spécialisé en <strong>Angular</strong> et <strong>Symfony</strong>. De l\'architecture backend robuste aux interfaces soignées, je construis des produits digitaux performants et évolutifs.',
        action1: 'Démarrer un projet',
        action2: 'Découvrir mon expertise',
    ...
    en: {
      ...
      hero: {
        ...
        lead: 'Technical Lead and Full-Stack developer with 10+ years of experience, specialized in <strong>Angular</strong> and <strong>Symfony</strong>. From robust backend architecture to polished interfaces, I build scalable, high-performance digital products.',
        action1: 'Start a project',
        action2: 'Discover my expertise',
